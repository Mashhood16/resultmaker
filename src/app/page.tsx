    ...
    <main className="min-h-screen bg-background text-foreground selection:bg-primary/30 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center lg:pt-32">
        <div className="mx-auto max-w-4xl animate-in fade-in slide-in-from-bottom-8 duration-1000">
          <div className="inline-flex items-center justify-center px-4 py-1.5 mb-6 rounded-full bg-white/5 border border-white/10 text-indigo-300 text-sm font-semibold tracking-wide uppercase">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 border-t border-border bg-background/50 backdrop-blur-3xl">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            <div key={i} className="bg-card border border-border rounded-3xl p-8 hover:bg-accent/50 transition-all duration-300 group hover:-translate-y-1">
      ...
      <footer className="border-t border-border bg-background py-12 text-center">
        <p className="text-muted-foreground font-medium">© {new Date().getFullYear()} ResultMaker. All rights reserved.</p>
      </footer>
    </main>
  )
}
