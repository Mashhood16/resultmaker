...
export async function POST(req: Request) {
  ...
  try {
    ...
    const prompt = `You are an expert test creator. Generate a test with ${numQuestions || 5} multiple-choice questions about "${topic}". The difficulty level should be ${difficulty || 'medium'}.
